...
VERSION="${1:?usage: scripts/package-rust-release.sh <version>}"
XCFRAMEWORK_PATH="${REPO_ROOT}/Binaries/TokenizersRust.xcframework"
ARTIFACTS_DIR="${REPO_ROOT}/Artifacts"
ARCHIVE_BASENAME="TokenizersRust-${VERSION}.xcframework.zip"
ARCHIVE_PATH="${ARTIFACTS_DIR}/${ARCHIVE_BASENAME}"
CHECKSUM_PATH="${ARCHIVE_PATH}.checksum"

bash "${REPO_ROOT}/scripts/build-rust-xcframework.sh"
